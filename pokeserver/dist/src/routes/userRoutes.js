...
userRoutes.post("/register", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield server_js_1.pool.query("INSERT INTO users (username, password, home) VALUES ($1, $2, ST_GeogFromText($3)) RETURNING *", [username, hashedPassword, home]);
...
userRoutes.post("/login", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield server_js_1.pool.query("SELECT * FROM users WHERE username = $1", [
            username,
        ]);
...
userRoutes.get("/protected", auth_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const result = yield server_js_1.pool.query("SELECT id, username, ST_AsText(home) as home FROM users WHERE id = $1", [userId]);
...
userRoutes.get("/users", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield server_js_1.pool.query("SELECT * FROM users");
