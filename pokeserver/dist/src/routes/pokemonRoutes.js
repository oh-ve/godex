...
router.post("/", auth_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const userResult = yield pool.query("SELECT home FROM users WHERE id = $1", [user_id]);
        ...
        const distanceResult = yield pool.query("SELECT ST_Distance(ST_GeogFromText($1), $2) AS distance", [location, userHome]);
        ...
        const result = yield pool.query("INSERT INTO pokemon (user_id, name, nickname, is_shiny, iv, date, location, distance) VALUES ($1, $2, $3, $4, $5, $6, ST_GeogFromText($7), $8) RETURNING *", [user_id, name, nickname, is_shiny, iv, date, location, isMoreThan100Km]);
