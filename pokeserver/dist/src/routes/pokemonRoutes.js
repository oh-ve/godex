...
router.get("/account/:accountId", auth_1.authenticateToken, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      try {
        ...
        const updateResult = yield client.query(
        ...
        const distanceResult = yield client.query(
...
router.delete("/", auth_1.authenticateToken, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
